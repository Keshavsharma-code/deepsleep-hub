...
[![Version](https://img.shields.io/badge/Version-2.5--stable-blue.svg)](https://github.com/Keshavsharma-code/deepsleep-hub/releases)
...
1. Download the latest production build: [**DeepSleep-Hub-v2.5.zip**](https://github.com/Keshavsharma-code/deepsleep-hub/raw/main/DeepSleep-Hub-v2.5.zip).
